...
export default async function AboutPage({
  ...
  const genreByLocale: Record<Locale, string> = {
    zh: '流行 · 爵士 · 游戏原声',
    en: 'Pop · Jazz · Game OST',
    ja: 'ポップ・ジャズ・ゲーム OST',
    ko: '팝 · 재즈 · 게임 OST',
  };

  const facts = [
    { icon: MapPin, label: dict.about.factLabels.basedIn, value: profile.basedIn[locale] },
    { icon: GraduationCap, label: dict.about.factLabels.education, value: profile.education[locale] },
    { icon: Sparkles, label: dict.about.factLabels.affiliation, value: profile.affiliation[locale] },
    { icon: Music2, label: dict.about.factLabels.genre, value: genreByLocale[locale] },
  ];
      ...
      <div className="mx-auto max-w-[1100px]">
        ...
        <section className="relative mt-6 overflow-hidden rounded-[3rem] glass-card-warm fade-up" style={{ animationDelay: '0s' }}>
          ...
          <div className="relative grid items-center gap-12 px-6 md:px-16 py-16 md:py-24 md:grid-cols-[auto_1fr]">
            ...
            <div className="mx-auto md:mx-0 fade-up" style={{ animationDelay: '0.1s' }}>
            ...
            <div className="text-center md:text-left fade-up" style={{ animationDelay: '0.18s' }}>
        ...
        {/* Story */}
        <section className="mt-16 md:mt-24 grid gap-8 md:grid-cols-12 fade-up" style={{ animationDelay: '0.35s' }}>
          <div className="md:col-span-4 fade-up" style={{ animationDelay: '0.45s' }}>
          ...
          <div className="md:col-span-8 space-y-5 text-base md:text-lg leading-[1.8] text-[var(--color-ink-soft)] fade-up" style={{ animationDelay: '0.55s' }}>
        ...
        {/* Facts grid */}
        <section className="mt-16 md:mt-24 fade-up" style={{ animationDelay: '0.7s' }}>
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {facts.map((f, i) => (
              <div
                key={f.label}
                className={
                  'rounded-[2rem] p-7 bg-gradient-to-br fade-up ' +
                  (i % 2 === 0
        ...
        {/* Timeline */}
        <section className="mt-16 md:mt-24 fade-up" style={{ animationDelay: '1.05s' }}>
          <p className="script text-2xl text-[var(--color-rose)] mb-6 text-center">
          ...
          <ol className="relative mx-auto max-w-3xl">
            ...
            {timeline.map((m, i) => (
              <li key={m.year + m.title.en} className="relative pl-10 md:pl-0 md:grid md:grid-cols-2 md:gap-10 py-5 fade-up" style={{ animationDelay: `${1.15 + i * 0.08}s` }}>
        ...
        {/* Contact */}
        <section className="mt-20 md:mt-28 fade-up" style={{ animationDelay: '1.45s' }}>
          <div className="relative overflow-hidden rounded-[3rem] bg-gradient-to-br from-[var(--color-rose)] via-[var(--color-violet)] to-[var(--color-sky)] p-10 md:p-16 text-center fade-up" style={{ animationDelay: '1.55s' }}>
